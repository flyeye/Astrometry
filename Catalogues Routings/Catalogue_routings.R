...
read_ucac4 <- function(path, start = 1, n = Inf, is_tyc_only = TRUE)
{
  ...
  for (i in 1:900)
  {
    ...
    # ïðåîáðàçîâàòü íóæíûå ñòîëáöû
    
    if (is_tyc_only)
    {
        # îòôèëüòðîâàòü íå Tycho çâåçäû 
...
make_tgas_exp <- function(tgas_data, tyc2_data, tyc2_sp_data, hip_data)
{
   ...
   # Ëó÷åâóþ ñêîðîñòü îòêóäà òî
   
   # âû÷èñëèòü M = m + 5 + 5 lg(px).
   ...
   # âû÷èñëèòü M ñ ó÷åòîì ìåæçâåçäíîãî ïîãëàùåíèÿ
   
   # âû÷èñëèòü ñïåêòðàëüíûé ïàðàëëàêñ
