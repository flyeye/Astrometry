...
# ----------------------------------------------------------  
  ...
  g <- draw_OortParameter(solutions_bv, parameter = 4,
                          ...
                          x_par = 9, 
                          x_title = "B-V")
  ggsave(paste0("solutions/",filter_dist,"_RG_OL_K.png"), plot = g, width = 10, height = 5)
  ggsave(paste0("solutions/",filter_dist,"_RG_OL_K.eps"), plot = g, width = 10, height = 5)
  
  tgas_draw_all_OM_sol_comp(solutions = solutions_bv, 
                            ylims  = matrix(data = c(0, 15, 10, 30, 0, 15, -5, 5, -5, 2, -18, -8, -5, 5, -8, 3 , 5, 25, -7, 3, -10, 5), nrow = 2),
                            xlims = c(0.5, 2, 0.1),
                            xpar = 9, 
                            xtitle = "B-V", 
                            saveto = paste0("solutions/", filter_dist,"_RG_"))
